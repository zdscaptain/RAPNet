...
class MultiBlock(nn.Module):
    ...
    def forward(self, x, y, H2, H1):
        x = x + self.drop_path(
            self.attn(self.norm1(x), [self.norm2_1(y[0]), self.norm2_2(y[1]), self.norm2_3(y[2])], H2,
                      H2))  # self.norm2(y)이 F1에 대한 값
...
class FeedFormerHead_cat(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, pool_scales=(1, 2, 3, 6), **kwargs):
        ...
        self.cat_key = CatKey(pool_ratio=[1, 2, 4, 8],
...
class FeedFormerHead32(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, pool_scales=(1, 2, 3, 6), **kwargs):
        ...
        self.attn_c4_c3 = Block(dim1=c4_in_channels, dim2=c3_in_channels, num_heads=8, mlp_ratio=4,
                                # query:c4, key&value:c3
                                drop_path=0.1, pool_ratio=-2)
        self.attn_c3_c2 = Block(dim1=c4_in_channels, dim2=c2_in_channels, num_heads=8, mlp_ratio=4,
                                # query:c3, key&value:c2
                                drop_path=0.1, pool_ratio=2)
        self.attn_c2_c1 = Block(dim1=c4_in_channels, dim2=c1_in_channels, num_heads=8, mlp_ratio=4,
                                # query:c2, key&value:c1
                                drop_path=0.1, pool_ratio=4)
...
class FeedFormerHeadUNetPlus(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, pool_scales=(1, 2, 3, 6), **kwargs):
        ...
        self.attn_c4_c3 = BlockPlus(dim1=c4_in_channels, dim2=c3_in_channels, num_heads=8, mlp_ratio=4,
                                    # query:c4, key&value:c3
                                    drop_path=0.1, pool_ratio=2)
        self.attn_c3_c2 = BlockPlus(dim1=c4_in_channels, dim2=c2_in_channels, num_heads=8, mlp_ratio=4,
                                    # query:c3, key&value:c2
                                    drop_path=0.1, pool_ratio=4)
        self.attn_c2_c1 = BlockPlus(dim1=c4_in_channels, dim2=c1_in_channels, num_heads=8, mlp_ratio=4,
                                    # query:c2, key&value:c1
                                    drop_path=0.1, pool_ratio=8)
